...
import com.savebytes.campusbuddy.presentation.util.ApiResponse
...
interface AuthApiService {
    ...
    @GET("film/home")
    suspend fun getAllMovies() : ApiResponse<HomeResponse>
    ...
    suspend fun verifyToken(@Body request: Map<String, String>): AuthResponse
